...
for sizes in default_statistics_target_size:
    ...
    EXPLAIN SELECT COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.b > 0 AND One.b < 3500 AND Two.a > 21 AND Two.a < 120;
    EXPLAIN SELECT COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.b > 200 AND One.b < 2000 AND Two.a > 21 AND Two.a < 120;
    EXPLAIN SELECT COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.b > 2000 AND One.b < 3000 AND Two.a > 60 AND Two.a < 120;
    EXPLAIN SELECT COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.b > 2000 AND One.b < 4000 AND Two.a > 50 AND Two.a < 120;
    EXPLAIN SELECT COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.b > 2000 AND One.b < 5000 AND Two.a > 35 AND Two.a < 120;
    EXPLAIN SELECT COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.b > 1000 AND One.b < 6000 AND Two.a > 45 AND Two.a < 120;
    EXPLAIN SELECT COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.b > 2000 AND One.b < 9000 AND Two.a > 21 AND Two.a < 120;
    EXPLAIN SELECT COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.c > 100 AND One.c < 350 AND Two.a > 41;
    EXPLAIN SELECT COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.c > 200 AND One.c < 400 AND  Two.a < 101;
    ...
    EXPLAIN SELECT COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.c > 0 AND One.c < 450 AND Two.a > 21 AND Two.a < 120;
    EXPLAIN SELECT COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.c > 150 AND One.c < 200 AND Two.a > 45 AND Two.a < 120;
    EXPLAIN SELECT COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.c > 300 AND One.c < 350 AND Two.a > 80 AND Two.a < 120;
    ...
    EXPLAIN SELECT COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.d > 20 AND One.d < 120 AND Two.a > 30 AND Two.a < 100;
    EXPLAIN SELECT COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.d > 20 AND One.d < 120 AND Two.a > 100 AND Two.a < 120;
    EXPLAIN SELECT COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.b > 1 AND One.b < 6000 AND Two.a > 41 AND Two.a < 120;
    EXPLAIN SELECT COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.b > 3000 AND One.b < 5999 AND Two.a > 30 AND Two.a < 120;
    EXPLAIN SELECT COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.d > 20 AND One.d < 50 AND Two.a > 45 AND Two.a < 120;
    EXPLAIN SELECT COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.d > 30 AND One.d < 80 AND Two.a > 21 AND Two.a < 120;
    ...
    EXPLAIN SELECT COUNT(*) FROM One JOIN Two ON One.id = Two.id WHERE One.d < 30 AND Two.a > 60 AND Two.a < 70;
    EXPLAIN SELECT COUNT(*) FROM One JOIN Two ON One.id = Two.id WHERE One.b > 4000 AND One.b < 5000 AND Two.a < 30;
