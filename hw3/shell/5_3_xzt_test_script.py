...
for sizes in default_statistics_target_size:
    ...
    EXPLAIN SELECT  COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.b > 100 AND One.b < 9099 AND Two.a > 41 AND Two.a < 61;
    EXPLAIN SELECT  COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.b > 200 AND One.b < 8199 AND Two.a > 61 AND Two.a < 81;
    EXPLAIN SELECT  COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.b > 300 AND One.b < 7299 AND Two.a > 81 AND Two.a < 101;
    EXPLAIN SELECT  COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.b > 400 AND One.b < 6399 AND Two.a > 101 AND Two.a < 121;
    EXPLAIN SELECT  COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.b > 500 AND One.b < 5499 AND Two.a > 21 AND Two.a < 41;
    EXPLAIN SELECT  COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.b > 600 AND One.b < 4599 AND Two.a > 41 AND Two.a < 61;
    EXPLAIN SELECT  COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.b > 700 AND One.b < 3699 AND Two.a > 61 AND Two.a < 81;
    ...
    EXPLAIN SELECT  COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.c > 1 AND One.c < 500 AND Two.a > 22 AND Two.a < 42;
    EXPLAIN SELECT  COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.c > 10 AND One.c < 490 AND Two.a > 42 AND Two.a < 62;
    EXPLAIN SELECT  COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.c > 20 AND One.c < 480 AND Two.a > 62 AND Two.a < 82;
    EXPLAIN SELECT  COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.c > 30 AND One.c < 470 AND Two.a > 82 AND Two.a < 102;
    EXPLAIN SELECT  COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.c > 40 AND One.c < 460 AND Two.a > 102 AND Two.a < 122;
    EXPLAIN SELECT  COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.c > 50 AND One.c < 450 AND Two.a > 22 AND Two.a < 42;
    EXPLAIN SELECT  COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.c > 60 AND One.c < 440 AND Two.a > 42 AND Two.a < 62;
    EXPLAIN SELECT  COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.c > 70 AND One.c < 430 AND Two.a > 62 AND Two.a < 82;
    ...
    EXPLAIN SELECT  COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.c > 200 AND One.c < 250 AND Two.a > 21 AND Two.a < 120;
    EXPLAIN SELECT  COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.c > 250 AND One.c < 300 AND Two.a > 21 AND Two.a < 120;
    ...
    EXPLAIN SELECT  COUNT(*) FROM One, Two WHERE One.id = Two.id AND One.d > 40 AND One.d < 60 AND Two.a > 21 AND Two.a < 120;
