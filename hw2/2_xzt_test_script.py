...
bloomfilter_sizes = [20000, 40000, 81920]
...
for sizes in bloomfilter_sizes:
	for counts in hashfunction_counts:
		...
		sql_commands = [
			"SELECT COUNT(*) FROM R, S WHERE R.ID = S.ID AND R.ID < 7500 AND S.ID > 2000",
			"SELECT COUNT(*) FROM R, S WHERE R.ID = S.ID AND R.ID < 7500 AND S.ID > 3000",
			"SELECT COUNT(*) FROM R, S WHERE R.ID = S.ID AND R.ID < 7500 AND S.ID > 4000",
			"SELECT COUNT(*) FROM R, S WHERE R.ID = S.ID AND R.ID < 7500 AND S.ID > 5000",
			"SELECT COUNT(*) FROM R, S WHERE R.ID = S.ID AND R.ID < 7500 AND S.ID > 6000"
		]
