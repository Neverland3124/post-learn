...
for sizes in bloomfilter_sizes:
	for counts in hashfunction_counts:
		...
		shell_command = './shell-wlt/run.sh'
		...
		start_command = "/cmshome/wangl157/postgresql-7.4.13/bin/postmaster -p 54323 -D /cmshome/wangl157/postgresql-7.4.13/data > /cmshome/wangl157/cscd43w24_space/hw/hw2/logfile 2>&1 &"
		...
		psql_command = "/cmshome/wangl157/postgresql-7.4.13/bin/psql test -p 54323 -f sql_commands.sql"
		...
		stop_command = "/cmshome/wangl157/postgresql-7.4.13/bin/pg_ctl stop -p 54323 -D /cmshome/wangl157/postgresql-7.4.13/data"
		subprocess.run(stop_command, shell=True)

		# Read the new content from the logfile
		logfile_path = "/cmshome/wangl157/cscd43w24_space/hw/hw2/logfile"
